...
abstract class BaseViewWidgetState<SW extends StatefulWidget, VMC extends BaseViewModelContract, VMS extends BaseViewModelState> extends State<SW> implements BaseViewContract {
...
class _ViewSelector<VMC extends BaseViewModelContract, VMS extends BaseViewModelState, T> extends StatelessWidget {
  final VMC vmContract;
